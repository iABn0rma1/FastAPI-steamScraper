...
class SteamStoreScraper:
    ...
    def ScrapeGames(self, n0Games=100, tags=["Discounts"]):
        """
        Scrapes game data for each tag specified in the 'tags' attribute and returns a dictionary.

        Args:
            n0Games (int): Number of games to scrape. Default is 100.
            tags (list): List of tags to filter games by. Default is ['Discounts'].
        ...
        url = f"{self.base_url}{filters}&maxprice=1800"
